...
- 답변을 할 때, 마지막에 어느 문제가 있으며 이러한 문제를 어떻게 해결/개선할 것인지 덪붙여라.
...
상세 규칙: `rules/comment.md`

- What이 아니라 Why를 설명한다. 코드로 자명한 내용은 주석으로 반복하지 않는다.
- 클래스는 역할을, 필드/상수는 단위와 근거를 남긴다.
- 코드와 어긋난 주석은 방치하지 않고 수정하거나 삭제한다.
...
- `rules/comment.md` — 주석/문서 작성 형식 변경
